...
/**
 * Spring Configuration file that loads the values from testing.properties for the FakeJmsBroker.
 *
 * This method of bringing in properties has been around since Spring 3.1.
